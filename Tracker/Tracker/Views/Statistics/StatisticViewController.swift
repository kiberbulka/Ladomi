...
final class StatisticViewController: UIViewController {
    ...
    private func dayWord(for count: Int) -> String {
        ...
        if remainder10 == 1 && remainder100 != 11 {
            return NSLocalizedString("tracker.day", comment: "")
        } else if remainder10 >= 2 && remainder10 <= 4 && (remainder100 < 10 || remainder100 >= 20) {
            return NSLocalizedString("tracker.2,3,4day", comment: "")
        } else {
            return NSLocalizedString("tracker.days", comment: "")
        }
    }
    ...
    private func makeInsightCard(item: StatisticsItem) -> UIView {
        ...
        titleLabel.font = .trackerBold(16)
        ...
        detailLabel.font = .trackerMedium(13)
