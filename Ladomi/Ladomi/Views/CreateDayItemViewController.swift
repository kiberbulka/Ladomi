...
final class CreateDayItemViewController: UIViewController {
    ...
    private lazy var createHabitButton: UIButton = {
        ...
        button.titleLabel?.font = .ladomiBold(22)
    ...
    private lazy var createLabel: UILabel = {
        let label = UILabel()
        let labelText = NSLocalizedString("createDayItem.title", comment: "Заголовок экрана создания ритма")
