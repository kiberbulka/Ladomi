...
protocol AddCategoryViewControllerDelegate: AnyObject {
    func didAddCategory(_ category: RitmoCategory)
}

class AddCategoryViewController: UIViewController {
    
    weak var delegate: AddCategoryViewControllerDelegate?
    var categoryToEdit: RitmoCategory?
    var categoryUpdated: ((RitmoCategory) -> Void)?
    ...
    @objc private func doneButtonTap() {
        ...
        let updatedCategory = RitmoCategory(
            title: title,
            ritmos: categoryToEdit?.ritmos ?? []
        )
